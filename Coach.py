...
# Awari: use json for readability and compatibility with other frameworks
import json
# temp hack:
...
class Coach():
    ...
    def executeEpisode(self):
        ...
        while True:
            ...
            if r!=0:
                # Awari: also add final move that finished the game
    ...
    def learn(self):
        ...
        for i in range(1, self.args.numIters + 1):
            ...
            if not self.skipFirstSelfPlay or i > 1:
                ...
                # Awari: regular list so it it json serializable
